...
describe("Get all Universities", () => {
   ...
   it('should return all universities', (done) => {
       let UniMock = sinon.mock(University);
       let expectedResults = { status: true, uni: [] };
    ...
    it('should return error', (done) => {
        let UniMock = sinon.mock(University);
        let expectedResults = { status: false, error: "Something went wrong" };
...
describe("Create a University", ()=>{
   // Test will pass if uni is saved
    it('should create a new university', (done) => {
       ...
       let UniMock = sinon.mock(new University(uniInfo));
